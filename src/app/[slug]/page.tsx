  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-6 py-16">
      ...
      <article className="mx-auto w-full max-w-[720px]">
        ...
        <div className="mt-10 prose prose-invert max-w-none prose-p:my-6 prose-p:text-[18px] prose-p:leading-8 prose-headings:font-semibold prose-headings:tracking-tight prose-h2:mt-14 prose-h2:mb-5 prose-h2:text-3xl prose-h2:text-white prose-h3:mt-10 prose-h3:mb-4 prose-h3:text-2xl prose-h3:text-white prose-a:text-amber-400 prose-strong:text-white prose-ul:my-6 prose-ol:my-6 prose-li:my-2 prose-li:text-[17px] prose-li:leading-8 prose-blockquote:border-l-2 prose-blockquote:border-amber-500 prose-blockquote:pl-4 prose-blockquote:text-zinc-300 [&_.ftc-disclosure]:my-8 [&_.ftc-disclosure]:rounded-2xl [&_.ftc-disclosure]:border [&_.ftc-disclosure]:border-white/10 [&_.ftc-disclosure]:bg-white/5 [&_.ftc-disclosure]:px-5 [&_.ftc-disclosure]:py-4 [&_.ftc-disclosure]:text-sm [&_.ftc-disclosure]:leading-7 [&_.faq-question]:mt-8 [&_.faq-question]:mb-2 [&_.faq-question]:text-xl [&_.faq-question]:font-semibold [&_.faq-question]:text-white">
