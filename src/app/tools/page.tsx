...
const tools = [
  {
    href: "/tools/free-testosterone-calculator",
  ...
  {
    href: "/tools/low-t-symptom-checker",
  ...
  {
    href: "/tools/testosterone-by-age-calculator",
  ...
  {
    href: "/tools/tdee-calculator-men",
...
export const metadata = {
  title: "Tools | ManUnlocked",
  description: "Calculator hub for testosterone, TRT cost, symptoms, and body composition tools.",
};
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-6 py-16">
      <div className="max-w-3xl space-y-4">
        <p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-500">Tools</p>
