...
export function Glp1FiberIntakeCalculator() {
  ...
  return (
    <section className="rounded-[2rem] border border-black/5 bg-white p-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)]">
      <h1 className="text-3xl font-semibold tracking-tight text-zinc-950">GLP-1 Fiber Intake Calculator</h1>

      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        <label className="flex flex-col">
          <span className="text-sm text-zinc-600">Calories (kcal)</span>
      ...
      <div className="mt-6 rounded-lg bg-zinc-100 border border-black/5 p-5">
        <p className="text-sm text-zinc-700">Direct answer: based on a standard guideline (14 g per 1000 kcal), target about <strong>{recommended} g fiber/day</strong>. Prioritize soluble fiber and increase slowly to avoid worsening GI symptoms.</p>
      </div>
