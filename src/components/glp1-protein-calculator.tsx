    ...
    <section className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/20">
      ...
      <div className="mt-6 rounded-lg bg-black/10 p-5">
        ...
        <div className="mt-4 text-sm text-zinc-400">
          ...
          <p>Sources: STEP trials and clinical guidance on lean mass preservation.</p>
        </div>
      </div>

      <div className="mt-6 prose max-w-none text-zinc-300">
        <h2>How much protein do you actually need on GLP-1?</h2>
        <p>Direct answer: more than the standard 0.8 g/kg recommendation — typically 1.2–1.6 g/kg is used in clinical guidance for people at risk of lean mass loss during weight loss on GLP-1 medications.</p>
        <p>Why: clinical trial data show a non-trivial portion of weight lost on semaglutide can be lean mass, so a higher protein target helps protect muscle when overall intake is reduced.</p>

        <h2>How do you hit that target when your appetite is tiny?</h2>
        <p>Direct answer: prioritize protein-dense, low-volume items (liquid protein, concentrated dairy, eggs, lean deli, protein powders), spread protein across small meals, and aim for high-protein snacks.</p>
        <ul>
        ...
        <p>Direct answer: repeat morning labs after a 12-week nutrition reset if symptoms persist; see a clinician sooner if you have unexplained severe fatigue, rapid strength loss, or other red flags.</p>
        ...
        <p>Direct answer: A 180 lb (82 kg) person using GLP-1 with moderate activity and standard intensity would target roughly {Math.round((1.2*activityFactor*medFactor*weightKg))}–{Math.round((1.6*activityFactor*medFactor*weightKg))} g/day. That can be hit with 3 meals of ~{perMeal3[0]}–{perMeal3[1]} g or 2 meals + 1 protein snack.</p>
